...
const SampleNavbar = () => {
    ...
    return (
        <div className={className}>
            <button className={`${className}_button`} onClick={(e) => handleClick(e, 0)}>{`Return Home`}</button>
            <button className={`${className}_button`} onClick={(e) => handleClick(e, 2)}>Create an Account</button>
        </div>
    )
}
