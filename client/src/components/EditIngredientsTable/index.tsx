...
interface Props {
    ...
    handleEditIngredient: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void,
...
const EditIngredientsTable: React.FC<Props> = ({ ingredients, handleEditIngredient, setEditIngredientActive, setIngName, setIngAmount, setSelectedItem }) => { 
    ...
    useEffect(() => {
        ...
        const itemsPerCol = (numItems / numCols)
    ...
    const className = 'EditIngredientsTable'
    return (
        <div className={className} style={{ gridTemplateRows: gridTemplateRowsTwo}} >
            ...
            <button className={`${className}_addButton`} onClick={handleEditIngredient} ref={buttonRef}>Add Ingredient</button>
